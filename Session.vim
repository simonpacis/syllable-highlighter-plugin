...
silent only
silent tabonly
cd ~/Documents/Dev/Development/.obsidian/plugins/syllable-highlighter-plugin
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 29 + 92) / 185)
exe 'vert 2resize ' . ((&columns * 74 + 92) / 185)
exe 'vert 3resize ' . ((&columns * 80 + 92) / 185)
argglobal
enew
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let &fdl = &fdl
let s:l = 155 - ((24 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 155
